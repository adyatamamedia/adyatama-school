...
<div class="row">
    <div class="col-lg-12">
        <form action="<?= base_url('dashboard/posts/update/' . $post->id) ?>" method="post">
            <?= csrf_field() ?>
                            ...
                            <!-- Featured Image Selector -->
                             <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="featured_image_display" readonly placeholder="No image selected" value="<?= $post->featured_media_id ? 'ID: ' . $post->featured_media_id : '' ?>">
