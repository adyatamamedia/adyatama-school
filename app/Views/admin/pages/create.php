                            ...
                            <div class="tab-content" id="pageTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="content-pane" role="tabpanel" aria-labelledby="content-tab">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="title" name="title" value="<?= old('title') ?>" placeholder="Masukkan judul halaman" required>
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="featured_image_display" readonly placeholder="Belum ada gambar">
