                    ...
                    <div class="tab-content" id="pageTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="content-pane" role="tabpanel" aria-labelledby="content-tab">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title" value="<?= old('title', $page->title) ?>" required>
                            </div>
                             ...
                             <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="foto" name="featured_image" value="<?= old('featured_image', $page->featured_image) ?>" readonly placeholder="No image selected">
                                    </div>
                                </div>
                            </div>
                        </div>
