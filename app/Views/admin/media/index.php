...
<div class="row mb-3">
    ...
    <div class="col-md-9 text-end">
        ...
        <a href="<?= base_url('dashboard/media/trash') ?>" class="btn btn-warning btn-sm me-2">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <?php if (current_user()->role !== 'guru'): ?>
                                <button type="button" class="btn btn-sm text-danger" onclick="showDeleteModal('<?= base_url('dashboard/media/delete/' . $item->id) ?>', 'Hapus media \'<?= esc($item->caption) ?>\'?')" title="Delete">
                ...
                <?php foreach ($media as $item) : ?>
                    <tr class="media-item-list" data-caption="<?= strtolower(esc($item->caption)) ?>">
                        ...
                        <td class="text-end">
                            ...
                            <?php if (current_user()->role !== 'guru'): ?>
                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="showDeleteModal('<?= base_url('dashboard/media/delete/' . $item->id) ?>', 'Hapus media \'<?= esc($item->caption) ?>\'?')" title="Delete">
                                <i class="fas fa-trash"></i>
                            </button>
                            <?php endif; ?>
                        </td>
